...
df_bank_statement = spark.read.parquet("s3://pysparkapi1/parquet/")
...
df_ticker_price_sgd = spark.read.parquet("s3://pysparkapi1/api_response/reponse/*/")
...
df_bank_statement.write.parquet("s3://pysparkapi1/processed/")
