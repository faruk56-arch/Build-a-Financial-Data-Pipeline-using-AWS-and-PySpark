SELECT * FROM "AwsDataCatalog"."pysparkapidb"."processedprocessed" limit 300;

SELECT 
    account_no, 
    SUM(COALESCE(withdrawal_sgd_amt, 0)) AS total_withdrawals_sgd, 
    SUM(COALESCE(deposit_sgd_amt, 0)) AS total_deposits_sgd
FROM "AwsDataCatalog"."pysparkapidb"."processedprocessed" 
GROUP BY account_no;
...
FROM
  "AwsDataCatalog"."pysparkapidb"."processedprocessed" 
GROUP BY
  deposit_currency;
